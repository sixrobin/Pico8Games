...
function pl_spdboost()
		...
		pl_spdboost_timer=pl_spdboost_dur
end

function pl_spdboost_update()
		if (pl_spdboost_timer>0) then
				pl_spdboost_timer-=1
				if (pl_spdboost_timer==0) then
						-- boost over.
...
function bullets_update()
		...
		bullets_spdboost_update()
		laser_update()
end

function bullets_add()
		local _spd=bullets_spd
		if bullets_spdboost_timer>0 then
...
function bullets_spdboost()
		...
		bullets_spdboost_timer=bullets_spdboost_dur
end

function bullets_spdboost_update()
		if (bullets_spdboost_timer>0) then
				bullets_spdboost_timer-=1
		end
end

function laser_toggle(_state)
		laser_on=_state
		if (laser_on) laser_timer=laser_dur
end
...

